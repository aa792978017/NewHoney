<template>
               ...
               <el-dropdown>
                  <span class="el-dropdown-link" >
                   ...
                   <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item style="padding: 0px"><a @click="loginOut" style="text-decoration: none; width: 100%; height: 100%;padding: 20px" >注销账号</a></el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
                <el-dropdown>
                    <span class="el-dropdown-link">
  ...
  <el-footer class="nmd">
    ...
    <el-menu-item index="honeycontrol" v-if="authority"><p class="menu-1"  style="font-size:18pt" ><i class="iconfont">&#xe606;</i>平台管理</p></el-menu-item>
    </el-menu>
    <div class="footer-1">
