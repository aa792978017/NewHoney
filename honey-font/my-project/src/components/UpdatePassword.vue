            ...
            <div class="login"  >
                <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="旧密码" prop="oldpassword">
                        <el-input type="password" v-model="ruleForm2.oldpassword" autocomplete="off" style="width: 400px;height: 40px"></el-input>
                    </el-form-item>
    ...
    export default {
      ...
      methods: {
        ...
        submitForm () {
          ...
          this.ruleForm2.username !== '' && this.ruleForm2.checkPass !== ''&& this.ruleForm2.oldpassword !== '') {
               var json = {
              ...
              var self=this
              self.$axios.post('/login', json).then(function (response) {
                  if (response.data.statusCode === 200) {
                      self.$axios.post('/updatepassword', json2).then(function (response) {
                        if (response.data.statusCode === 200) {
